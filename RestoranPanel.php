...
<div class="list-group" style="width:300px; ">
                ...
                <a href="RestoranPanel.php" class="list-group-item list-group-item-action active">        Restoranları Düzenle    </a>
        ...
        <?php require "AdminPanel.php"; ?>
            ...
            <h3>Ürün Ekleme</h3>
                ...
                <button type="submit" class="btn btn-primary" onclick="window.location.href='UrunEkle.php?tablo_adi=restoranlar'" style="margin-bottom: 20px;">Restoran Ekle</button>
...
<?php foreach ($stmt as $urun) {?>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-secondary" onclick="location.href='UrunGuncelle.php?id=<?= $urun['id'] ?>&tablo_adi=restoranlar'">Düzenle</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-danger" onclick="location.href='UrunSil.php?id=<?= $urun['id'] ?>&tablo_adi=restoranlar'">Sil</button>
                            </td>
                        </tr>
