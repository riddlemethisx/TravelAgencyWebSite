...
$stmt = $db->query('SELECT * FROM hediyelikesyalar ORDER BY id ASC', PDO::FETCH_ASSOC);
?>
...
<div class="list-group" style="width:300px; ">
                ...
                <a href="HediyelikEsyaPanel.php" class="list-group-item list-group-item-action active">Hediyelik Eşyaları Düzenle</a>
        ...
        <?php require "AdminPanel.php"; ?>
            ...
            <h3>Ürün Ekleme</h3>
                ...
                <button type="submit" class="btn btn-primary" onclick="window.location.href='UrunEkle.php?tablo_adi=hediyelikesyalar'" style="margin-bottom: 20px;">Ürün Ekle</button>
...
<?php foreach ($stmt as $urun) {?>
            ...
            <td> <img width="40px" height="40px" src="<?= $urun['urun_resmi'] ?>" ></td>
                            ...
                            <td>
                                <button type="button" class="btn btn-secondary" onclick="location.href='UrunGuncelle.php?id=<?= $urun['id'] ?>&tablo_adi=hediyelikesyalar'">Düzenle</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-danger" onclick="location.href='UrunSil.php?id=<?= $urun['id'] ?>&tablo_adi=hediyelikesyalar'">Sil</button>
                            </td>
                        </tr>
