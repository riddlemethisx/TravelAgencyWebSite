...
$stmt = $db->query('SELECT * FROM urunler ORDER BY id ASC', PDO::FETCH_ASSOC);
?>
...
<div class="list-group" style="width:300px; ">
                <a href="YemekPanel.php" class="list-group-item list-group-item-action active">Yemek Ürünlerini Düzenle</a>
        ...
        <?php require "AdminPanel.php"; ?>
            ...
            <h3>Ürün Ekleme</h3>
                ...
                <button type="submit" class="btn btn-primary" onclick="window.location.href='UrunEkle.php?tablo_adi=urunler'" style="margin-bottom: 20px;">Ürün Ekle</button>
...
<?php foreach ($stmt as $urun) {?>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-secondary" onclick="location.href='UrunGuncelle.php?id=<?= $urun['id'] ?>&tablo_adi=urunler'">Düzenle</button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-danger" onclick="location.href='UrunSil.php?id=<?= $urun['id'] ?>&tablo_adi=urunler'">Sil</button>
                            </td>
                        </tr>
